...
const top = defineModel<string | null>("top");
const bottom = defineModel<string | null>("bottom");
const left = defineModel<string | null>("left");
const right = defineModel<string | null>("right");
